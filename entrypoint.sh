...
then
    ...
    flock -xn $LOCKDIR -c 'while sleep 5; do /usr/games/steamcmd +runscript /usr/games/gameserver/update.txt && break; done' || flock -x $LOCKDIR -c '/usr/games/steamcmd +login anonymous +quit'
fi
